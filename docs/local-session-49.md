...
12.26/~13/12.63. State-cache off контроль: первое окно12.10 FPS, CPU82.23 мс,
...
Для анализа материала запущен новый RenderDoc-прогон (19:25), пользователь нажимает F1
после посадки с хорошо видимой яркой кроной. Автоматический capture не используется.

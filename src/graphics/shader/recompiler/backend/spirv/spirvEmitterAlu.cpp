...
uint32_t EmitFPSaturate32(EmitterState& state, uint32_t arg0) {
	// The GCN clamp modifier runs in DX10_CLAMP mode on PS5 shaders and flushes NaN to +0.
	// FClamp leaves NaN undefined (NVIDIA propagates it): ASTRO BOT builds sign(x) as
